...
public: // Function declarations
  ...
  void initialize(string state);          // Initialize system properties
  void initialize_properties(string state);// Initialize properties for measurement
  void finalize(string state);            // Finalize system and clean up
  void write_configuration(string state); // Write final system configuration to XYZ file
  void write_XYZ(int nconf, string state);  // Write system configuration in XYZ format on the fly
  void write_velocities(string state);    // Write final particle velocities to file
  ...
  void block_reset(int blk, string state);  // Reset block averages
  void measure();             // Measure properties of the system
  void averages(int blk, string state);     // Compute averages of properties
