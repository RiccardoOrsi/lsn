...
public: // Function declarations
  ...
  void initialize(string in, string out);          // Initialize system properties
  void initialize_properties(string out);// Initialize properties for measurement
  void finalize(string out);            // Finalize system and clean up
  void write_configuration(string out); // Write final system configuration to XYZ file
  void write_XYZ(int nconf, string out);  // Write system configuration in XYZ format on the fly
  void write_velocities(string out);    // Write final particle velocities to file
  ...
  void block_reset(int blk, string out);  // Reset block averages
  void measure();             // Measure properties of the system
  void averages(int blk, string out);     // Compute averages of properties
  ...
  void set_t(double t);
  void print_es6(string out, int blk);
